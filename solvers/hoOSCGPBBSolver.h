...
#include "oscGPBBSolver.h"
#include "hoNDArray_fileio.h"
#include <sstream>

namespace Gadgetron{

template<class ARRAY_TYPE> class hoOSCGPBBSolver : public oscGPBBSolver<ARRAY_TYPE>{

	typedef typename ARRAY_TYPE::element_type ELEMENT_TYPE;
	typedef typename realType<ELEMENT_TYPE>::Type REAL;
public:
	virtual ~hoOSCGPBBSolver(){};
protected:
 ...
 */
template<class T> class hoOSCGPBBSolver<cuNDArray<T> > {
	virtual void hoOSCGPBBSolver_only_works_for_host_arrays() =0;
};
}
