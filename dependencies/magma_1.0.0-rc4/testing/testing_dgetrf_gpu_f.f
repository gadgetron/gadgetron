...
!---- Call magma solve -------------
      call magma_dgetrs_gpu('n', n, nrhs, devptrA, ldda, ipiv, devptrB, 
     $                      ldda, info)
...
!---- Solve using LAPACK ----------------------------------------------
c      call dgesv(n, nrhs, h_A2, lda, ipiv, h_X, lda, info)

!---- Compare the two results ------
      Anorm = dlange('I', n, n,    h_A, lda, work)
      Bnorm = dlange('I', n, nrhs, h_B, lda, work)

      call dgemm('n', 'n', n,  nrhs, n, zone, h_A, lda, h_X, lda,
     $           mzone, h_B, lda)
