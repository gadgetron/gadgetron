...
!---- Call magma LU ----------------
      ...
      call magma_sgetrf_gpu(n, n, devptrA, ldda, ipiv, info)
...
!---- Call magma solve -------------
      call magma_sgetrs_gpu('n', n, nrhs, devptrA, ldda, ipiv, devptrB, 
     $                      ldda, info)
...
!---- Solve using LAPACK ----------------------------------------------
c      call sgesv(n, nrhs, h_A2, lda, ipiv, h_X, lda, info)

!---- Compare the two results ------
      Anorm = slange('I', n, n,    h_A, lda, work)
      Bnorm = slange('I', n, nrhs, h_B, lda, work)

      call sgemm('n', 'n', n,  nrhs, n, zone, h_A, lda, h_X, lda,
     $           mzone, h_B, lda)
