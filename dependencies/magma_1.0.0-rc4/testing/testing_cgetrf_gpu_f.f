...
!
      ...
      external clange, cgemm, cgesv

      real clange
      integer cublas_alloc

      real              :: rnumber(2), Anorm, Bnorm, Rnorm 
      real, allocatable :: work(:)
      complex, allocatable       :: h_A(:), h_B(:), h_X(:)
      complex, allocatable       :: h_A2(:)
...
!---- Call magma LU ----------------
      ...
      call magma_cgetrf_gpu(n, n, devptrA, ldda, ipiv, info)
...
!---- Call magma solve -------------
      call magma_cgetrs_gpu('n', n, nrhs, devptrA, ldda, ipiv, devptrB, 
     $                      ldda, info)
...
!---- Solve using LAPACK ----------------------------------------------
c      call cgesv(n, nrhs, h_A2, lda, ipiv, h_X, lda, info)

!---- Compare the two results ------
      Anorm = clange('I', n, n,    h_A, lda, work)
      Bnorm = clange('I', n, nrhs, h_B, lda, work)

      call cgemm('n', 'n', n,  nrhs, n, zone, h_A, lda, h_X, lda,
     $           mzone, h_B, lda)
