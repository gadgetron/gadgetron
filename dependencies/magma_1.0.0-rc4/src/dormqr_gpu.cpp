...
/*  -- MAGMA (version 1.0) --
    ...
    A       (input) DOUBLE_PRECISION array, dimension (LDDA,K)
    ...
    C       (input/output) DOUBLE_PRECISION array, dimension (LDDC,N)
    ...
    DT      (input) DOUBLE_PRECISION array that is the output (the 9th argument)
            of magma_dgeqrf_gpu.
