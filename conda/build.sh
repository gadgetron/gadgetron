...
if [[ $(uname) =~ Darwin ]]; then
   ...
   export SYSTEM_DIRECTORIES_TO_IGNORE='Applications/Xcode.app_14.0.1.app/Contents/Developer/usr/bin;/Applications/Xcode_14.0.1.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.3.sdk/usr/lib'
