...
namespace Gadgetron {
    namespace Lapack {
		...
		Int gesvd(SVDType jobu, SVDType jobvt, size_t m, size_t n, float* a, size_t lda, float* s, float* u, size_t ldu, float* vt, size_t ldvt, float* superb);
		Int gesvd(SVDType jobu, SVDType jobvt, size_t m, size_t n, double* a, size_t lda, double* s, double* u, size_t ldu, double* vt, size_t ldvt, double* superb);
		Int gesvd(SVDType jobu, SVDType jobvt, size_t m, size_t n, std::complex<float>* a, size_t lda, float* s, std::complex<float>* u, size_t ldu, std::complex<float>* vt, size_t ldvt, float* superb);
		Int gesvd(SVDType jobu, SVDType jobvt, size_t m, size_t n, std::complex<double>* a, size_t lda, double* s, std::complex<double>* u, size_t ldu, std::complex<double>* vt, size_t ldvt, double* superb);
