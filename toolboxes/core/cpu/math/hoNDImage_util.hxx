...
namespace Gadgetron
{
    ...
    bool downsampleImageBy2WithAveraging(const hoNDImage<T, D>& in, BoundaryHandlerType& bh, hoNDImage<T, D>& out)
    {
        try
        {
            ...
            if ( D == 2 )
            {
                long long sx = (long long)dim_out[0];
                long long sy = (long long)dim_out[1];
            ...
            else if ( D == 3 )
            {
                long long sx = (long long)dim_out[0];
                long long sy = (long long)dim_out[1];
                long long sz = (long long)dim_out[2];
            ...
            else if ( D == 4 )
            {
                ...
                long long sy = (long long)dim_out[1];
                long long sz = (long long)dim_out[2];
                long long st = (long long)dim_out[3];
            ...
            else
            {
                ...
                long long N = out.get_number_of_elements();
    ...
    bool expandImageBy2(const hoNDImage<T, D>& in, BoundaryHandlerType& bh, hoNDImage<T, D>& out)
    {
        try
        {
            ...
            if ( D == 2 )
            {
                long long sx = (long long)dim[0];
                long long sy = (long long)dim[1];
                ...
                long long sx_out = (long long)out.get_size(0);
                long long sy_out = (long long)out.get_size(1);
            ...
            else if ( D == 3 )
            {
                ...
                long long sx_out = (long long)out.get_size(0);
                long long sy_out = (long long)out.get_size(1);
                long long sz_out = (long long)out.get_size(2);
            ...
            else
            {
                ...
                long long N = (long long)(out.get_number_of_elements());
