...
namespace Gadgetron{
  ...
  template<class T> void hoNDFFT<T>::fft_int(hoNDArray< std::complex<T> >* input, unsigned long long dim_to_transform, int sign)
  {
    ...
    if (dim_to_transform != 0)
      {
	for (unsigned long long i = 0; i < dim_to_transform; i++)
	  {
	...
	for (unsigned long long i = dim_to_transform+1; i < input->get_number_of_dimensions(); i++)
	  {
      ...
      {
	for (unsigned long long i = 1; i < input->get_number_of_dimensions(); i++)
	  {
  ...
  template<> void hoNDFFT<double>::set_function_pointers()
  {
    ...
    template<typename T> 
    inline unsigned long long hoNDFFT<T>::fftshiftPivot(unsigned long long x)
    {
        return (unsigned long long)(ceil(x*0.5));
    }

    template<typename T> 
    inline unsigned long long hoNDFFT<T>::ifftshiftPivot(unsigned long long x)
    {
        return (unsigned long long)(floor(x*0.5));
    }

    template<typename T> 
    inline bool hoNDFFT<T>::fftshift1D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long pivot)
    {
        try
        {
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshift1D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long pivot) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::ifftshift1D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long pivot)
    {
        return fftshift1D(a, r, x, pivot);
    }

    template<typename T> 
    bool hoNDFFT<T>::fftshiftPivot1D(ComplexType* a, unsigned long long x, unsigned long long n, unsigned long long pivot)
    {
        try
        {
            long long counter;
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshiftPivot1D(ComplexType* a, unsigned long long x, unsigned long long n, unsigned long long pivot) ...");
            return false;
        }
    ...
    template<typename T> 
    bool hoNDFFT<T>::fftshiftPivot1D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long n, unsigned long long pivot)
    {
        try
        {
            long long counter;
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshiftPivot1D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long n, unsigned long long pivot) ...");
            return false;
        }
    ...
    bool hoNDFFT<T>::fftshift1D(hoNDArray< ComplexType >& a)
    {
        try
        {
            unsigned long long x = a.get_size(0);
            unsigned long long pivot = fftshiftPivot(x);
            unsigned long long numOfShifts = a.get_number_of_elements()/x;
    ...
    bool hoNDFFT<T>::ifftshift1D(hoNDArray< ComplexType >& a)
    {
        ...
        {
            unsigned long long x = a.get_size(0);
            unsigned long long pivot = ifftshiftPivot(x);
            unsigned long long numOfShifts = a.get_number_of_elements()/x;
    ...
    template<typename T> 
    bool hoNDFFT<T>::fftshiftPivot2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n, unsigned pivotx, unsigned pivoty)
    {
        try
        {
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshiftPivot2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n, unsigned pivotx, unsigned pivoty) ...");
            return false;
        }
    ...
    template<typename T> 
    bool hoNDFFT<T>::fftshiftPivot2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n, unsigned pivotx, unsigned pivoty)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshiftPivot2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n, unsigned pivotx, unsigned pivoty) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::fftshift2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshift2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::ifftshift2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::ifftshift2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::fftshift2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshift2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::ifftshift2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::ifftshift2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n) ...");
            return false;
        }
    ...
    {
        unsigned long long n = a.get_number_of_elements()/(a.get_size(0)*a.get_size(1));
    ...
    template<typename T> 
    bool hoNDFFT<T>::fftshiftPivot3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n, unsigned pivotx, unsigned pivoty,  unsigned pivotz)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
            ...
            for ( tt=0; tt<(long long)n; tt++ )
            {
                unsigned long long ay, ry, az, rz;
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshiftPivot3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n, unsigned pivotx, unsigned pivoty,  unsigned pivotz) ...");
            return false;
        }
    ...
    template<typename T> 
    bool hoNDFFT<T>::fftshiftPivot3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n, unsigned pivotx, unsigned pivoty,  unsigned pivotz)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshiftPivot3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n, unsigned pivotx, unsigned pivoty,  unsigned pivotz) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::fftshift3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshift3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::ifftshift3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::ifftshift3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::fftshift3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::fftshift3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n) ...");
            return false;
        }
    ...
    template<typename T> 
    inline bool hoNDFFT<T>::ifftshift3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n)
    {
        try
        {
            GADGET_CHECK_RETURN_FALSE(a!=NULL);
        ...
        {
            GADGET_ERROR_MSG("Errors in hoNDFFT<T>::ifftshift3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n) ...");
            return false;
        }
    ...
    {
        unsigned long long n = a.get_number_of_elements()/(a.get_size(0)*a.get_size(1)*a.get_size(2));
    ...
    template<typename T> 
    bool hoNDFFT<T>::configureFFTHandle(long long NDim, MKL_LONG* dim, DFTI_CONFIG_VALUE fftPresion, unsigned long long n, DFTI_DESCRIPTOR_HANDLE& handle)
    {
        long long ii;
    ...
    template<typename T> 
    bool hoNDFFT<T>::configureFFTHandleOutOfPlace(long long NDim, MKL_LONG* dim, DFTI_CONFIG_VALUE fftPresion, unsigned long long n, DFTI_DESCRIPTOR_HANDLE& handle)
    {
        long long ii;
    ...
    {
        unsigned long long n = a.get_number_of_elements()/a.get_size(0);
