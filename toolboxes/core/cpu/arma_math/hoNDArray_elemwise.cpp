...
#pragma omp parallel for
    ...
    template<class T> boost::shared_ptr< hoNDArray<T> > real_imag_to_complex( hoNDArray<typename realType<T>::Type>* real, hoNDArray<typename realType<T>::Type>* imag )
    {
        ...
        unsigned long long N = real->get_number_of_elements();
    ...
    bool complex_to_imag(const hoNDArray<T>& cplx, hoNDArray<typename realType<T>::Type>& imag)
    {
        try
        {
            ...
            unsigned long long N = imag.get_number_of_elements();
    ...
    template<class T> void normalize( hoNDArray<T> *x, typename realType<T>::Type val )
    {
        ...
        unsigned long long max_idx = amax(x);
...
#pragma omp parallel for
    ...
    bool minAbsolute(const hoNDArray<float>& x, float& r, unsigned long long& ind)
    {
        try
        {
            MKL_INT n = x.get_number_of_elements();
            MKL_INT incx = 1;
            ind = (unsigned long long)(isamin(&n, x.begin(), &incx));
            r = x.at(ind);
        }
        catch(...)
        {
    ...
    bool maxAbsolute(const hoNDArray<float>& x, float& r, unsigned long long& ind)
    {
        try
        {
            MKL_INT n = x.get_number_of_elements();
            MKL_INT incx = 1;
            ind = (unsigned long long)(isamax(&n, x.begin(), &incx));
            r = x.at(ind);
        }
        catch(...)
        {
    ...
    bool addEpsilon(hoNDArray<float>& x)
    {
        try
        {
            unsigned long long n = x.get_number_of_elements();
            float* pX = x.begin();
    ...
    bool conv2(const hoNDArray<float>& x, const hoNDArray<float>& ker, hoNDArray<float>& z)
    {
        try
        {
            ...
            unsigned long long kerRO = ker.get_size(0);
            unsigned long long kerE1 = ker.get_size(1);

            unsigned long long num = x.get_number_of_elements()/(RO*E1);
    ...
    bool conv3(const hoNDArray<float>& x, const hoNDArray<float>& ker, hoNDArray<float>& z)
    {
        try
        {
            ...
            unsigned long long RO = x.get_size(0);
            unsigned long long E1 = x.get_size(1);
            unsigned long long E2 = x.get_size(2);

            unsigned long long kerRO = ker.get_size(0);
            unsigned long long kerE1 = ker.get_size(1);
            unsigned long long kerE2 = ker.get_size(2);

            unsigned long long num = x.get_number_of_elements()/(RO*E1*E2);
    ...
    bool minAbsolute(const hoNDArray<double>& x, double& r, unsigned long long& ind)
    {
        try
        {
            MKL_INT n = x.get_number_of_elements();
            MKL_INT incx = 1;
            ind = (unsigned long long)(idamin(&n, x.begin(), &incx));
            r = x.at(ind);
        }
        catch(...)
        {
    ...
    bool maxAbsolute(const hoNDArray<double>& x, double& r, unsigned long long& ind)
    {
        try
        {
            MKL_INT n = x.get_number_of_elements();
            MKL_INT incx = 1;
            ind = (unsigned long long)(idamax(&n, x.begin(), &incx));
            r = x.at(ind);
        }
        catch(...)
        {
    ...
    bool minAbsolute(const hoNDArray<GT_Complex8>& x, GT_Complex8& r, unsigned long long& ind)
    {
        try
        {
            MKL_INT n = x.get_number_of_elements();
            MKL_INT incx = 1;
            ind = (unsigned long long)(icamin(&n, reinterpret_cast<const MKL_Complex8*>(x.begin()), &incx));
            r = x.at(ind);
        }
        catch(...)
        {
    ...
    bool maxAbsolute(const hoNDArray<GT_Complex8>& x, GT_Complex8& r, unsigned long long& ind)
    {
        try
        {
            MKL_INT n = x.get_number_of_elements();
            MKL_INT incx = 1;
            ind = (unsigned long long)(icamax(&n, reinterpret_cast<const MKL_Complex8*>(x.begin()), &incx));
            r = x.at(ind);
        }
        catch(...)
        {
    ...
    bool minAbsolute(const hoNDArray<GT_Complex16>& x, GT_Complex16& r, unsigned long long& ind)
    {
        try
        {
            MKL_INT n = x.get_number_of_elements();
            MKL_INT incx = 1;
            ind = (unsigned long long)(izamin(&n, reinterpret_cast<const MKL_Complex16*>(x.begin()), &incx));
            r = x.at(ind);
        }
        catch(...)
        {
    ...
    bool maxAbsolute(const hoNDArray<GT_Complex16>& x, GT_Complex16& r, unsigned long long& ind)
    {
        try
        {
            MKL_INT n = x.get_number_of_elements();
            MKL_INT incx = 1;
            ind = (unsigned long long)(izamax(&n, reinterpret_cast<const MKL_Complex16*>(x.begin()), &incx));
            r = x.at(ind);
        }
        catch(...)
        {
    ...
    bool sumOverLastDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            boost::shared_ptr< std::vector<unsigned long long> > dim = x.get_dimensions();
            unsigned long long NDim = dim->size();

            std::vector<unsigned long long> dimR(NDim-1);
            ...
            unsigned long long NR = r.get_number_of_elements();
    ...
    bool sumOverSecondLastDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            std::vector<unsigned long long> dimR(NDim-1);
            std::vector<unsigned long long> dimRInternal(NDim-2);
            ...
            unsigned long long NS = x.get_number_of_elements()/lastDim;
            unsigned long long NR = r.get_number_of_elements()/lastDim;
            T* pA = const_cast<T*>(x.begin());
            T* pR = r.begin();
            ...
            //        for ( unsigned long long s=1; s<secondLastDim; s++ )
            //        {
            //            hoNDArray<T> tmp2;
    ...
    bool multiplyOverLastDimension(const hoNDArray<T>& x, const hoNDArray<T>& y, hoNDArray<T>& r)
    {
        try
        {
            ...
            boost::shared_ptr< std::vector<unsigned long long> > dimY = y.get_dimensions();

            unsigned long long NDim = dimY->size();
            ...
            unsigned long long lastDim = y.get_size(NDim-1);
            unsigned long long N = x.get_number_of_elements();
            const T* pX = x.begin();
            const T* pY = y.begin();
            T* pR = r.begin();
    ...
    bool sumOver1stDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        ...
        {
            unsigned long long RO = x.get_size(0);
            unsigned long long num = x.get_number_of_elements()/(RO);

            boost::shared_ptr< std::vector<unsigned long long> > dim = x.get_dimensions();

            std::vector<unsigned long long> dimAve(*dim);
            dimAve[0] = 1;
            r.create(&dimAve);
            ...
            {
                T xsum = pX[n*RO];
                for (unsigned long long ro=1; ro<RO; ro++ )
                {
                    xsum += pX[n*RO+ro];
                }
    ...
    bool sumOver2ndDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            for ( n=0; n<(int)num; n++ )
            {
                ...
                for (unsigned long long e1=1; e1<E1; e1++ )
                {
    ...
    bool sumOver3rdDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long num = x.get_number_of_elements()/(RO*E1*CHA);
            ...
            for ( n=0; n<(int)num; n++ )
            {
                ...
                for (unsigned long long cha=1; cha<CHA; cha++ )
                {
    ...
    template<typename T> bool sumOver4thDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long num = x.get_number_of_elements()/(RO*E1*CHA*N);
    ...
    template<typename T> bool sumOver5thDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long CHA = x.get_size(2);
            unsigned long long N = x.get_size(3);
            unsigned long long S = x.get_size(4);

            unsigned long long num = x.get_number_of_elements()/(RO*E1*CHA*N*S);
            ...
            for ( n=0; n<(int)num; n++ )
            {
                ...
                for (unsigned long long s=1; s<S; s++ )
                {
    ...
    bool multiplyOver3rdDimension(const hoNDArray<T>& x3D, const hoNDArray<T>& y4D, hoNDArray<T>& r)
    {
        try
        {
            boost::shared_ptr< std::vector<unsigned long long> > dimX = x3D.get_dimensions();
            boost::shared_ptr< std::vector<unsigned long long> > dimY = y4D.get_dimensions();
            ...
            std::vector<unsigned long long> dim2D(2);
            dim2D[0] = (*dimY)[0];
            dim2D[1] = (*dimY)[1];
    ...
    bool multiplyOver4thDimension(const hoNDArray<T>& x4D, const hoNDArray<T>& y5D, hoNDArray<T>& r)
    {
        try
        {
            boost::shared_ptr< std::vector<unsigned long long> > dimX = x4D.get_dimensions();
            boost::shared_ptr< std::vector<unsigned long long> > dimY = y5D.get_dimensions();
            ...
            unsigned long long RO = (*dimX)[0];
            unsigned long long E1 = (*dimX)[1];
            unsigned long long CHA = (*dimX)[2];

            int t, N3D = RO*E1*CHA;

            unsigned long long N = (*dimY)[3];
            unsigned long long num = x4D.get_number_of_elements()/(RO*E1*CHA);

            const T* pX = x4D.begin();
            const T* pY = y5D.begin();
            T* pR = r.begin();

            std::vector<unsigned long long> dim3D(3);
            dim3D[0] = RO;
            dim3D[1] = E1;
            dim3D[2] = CHA;
    ...
    template<typename T> 
    bool multiplyOver4thDimensionExcept(const hoNDArray<T>& x4D, const hoNDArray<T>& y5D, unsigned long long n, hoNDArray<T>& r, bool copyY2R)
    {
        try
        {
            boost::shared_ptr< std::vector<unsigned long long> > dimX = x4D.get_dimensions();
        ...
        {
            GADGET_ERROR_MSG("Errors in multiplyOver4thDimensionExcept(const hoNDArray<float>& x4D, const hoNDArray<float>& y5D, unsigned long long n, hoNDArray<float>& r, bool copyY2R) ... ");
            return false;
        }
        return true;
    }
    ...
    bool multiplyOver5thDimension(const hoNDArray<T>& x, const hoNDArray<T>& y, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long RO = (*dimX)[0];
            unsigned long long E1 = (*dimX)[1];
            unsigned long long E2 = (*dimX)[2];
            unsigned long long CHA = (*dimX)[3];

            int t, N4D = RO*E1*E2*CHA;

            unsigned long long N = (*dimY)[4];
            unsigned long long num = x.get_number_of_elements()/N4D;

            const T* pX = x.begin();
            const T* pY = y.begin();
            T* pR = r.begin();

            std::vector<unsigned long long> dim4D(4);
            dim4D[0] = RO;
            dim4D[1] = E1;
            dim4D[2] = E2;
            dim4D[3] = CHA;
    ...
    template<typename T> 
    bool multiplyOver5thDimensionExcept(const hoNDArray<T>& x, const hoNDArray<T>& y, unsigned long long n, hoNDArray<T>& r, bool copyY2R)
    {
        try
        {
            boost::shared_ptr< std::vector<unsigned long long> > dimX = x.get_dimensions();
        ...
        {
            GADGET_ERROR_MSG("Errors in multiplyOver5thDimensionExcept(const hoNDArray<T>& x, const hoNDArray<T>& y, unsigned long long n, hoNDArray<T>& r, bool copyY2R) ... ");
            return false;
        }
        return true;
    }
    ...
    template <typename T> 
    bool cropUpTo10DArray(const hoNDArray<T>& x, hoNDArray<T>& r, const std::vector<unsigned long long>& startND, std::vector<unsigned long long>& size)
    {
        ...
        std::vector<unsigned long long> start(10, 0);
        std::vector<unsigned long long> end(10, 0);
        ...
        unsigned long long ro, e1, cha, n, s, con, phs, rep, set, seg;

        std::vector<unsigned long long> srcInd(10), dstInd(10);
    ...
    template <typename T> 
    bool setSubArrayUpTo10DArray(const hoNDArray<T>& x, hoNDArray<T>& r, const std::vector<unsigned long long>& startND, std::vector<unsigned long long>& size)
    {
        GADGET_CHECK_RETURN_FALSE( startND.size() == size.size() );
        GADGET_CHECK_RETURN_FALSE( startND.size() <= 10 );
    ...
    bool stdOver3rdDimension(const hoNDArray<T>& x, hoNDArray<T>& std, bool NMinusOne)
    {
        try
        {
            ...
            std::vector<unsigned long long> dimStd(*dim);
    ...
    bool permuteLastTwoDimensions(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long NDim = dimX->size();
            ...
            unsigned long long E1 = x.get_size(NDim-2);
            unsigned long long E2 = x.get_size(NDim-1);

            std::vector<unsigned long long> dimR(*dimX);
            dimR[NDim-2] = E2;
            dimR[NDim-1] = E1;

            r.create(&dimR);

            unsigned long long N = x.get_number_of_elements()/E1/E2;
    ...
    bool permuteE2To3rdDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long E1 = x.get_size(1);
            unsigned long long CHA = x.get_size(2);
            unsigned long long SLC = x.get_size(3);
            unsigned long long E2 = x.get_size(4);
            ...
            unsigned long long N2D = RO*E1;
            unsigned long long N5D = RO*E1*CHA*E2*SLC;

            unsigned long long N = x.get_number_of_elements()/N5D;
            ...
            for ( n=0; n<N; n++ )
            {
                ...
                for ( e2=0; e2<E2; e2++ )
                {
                    for ( unsigned long long slc=0; slc<SLC; slc++ )
                    {
                        for ( unsigned long long cha=0; cha<CHA; cha++ )
                        {
    ...
    bool permuteE2To5thDimension(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long E1 = x.get_size(1);
            unsigned long long E2 = x.get_size(2);
            unsigned long long CHA = x.get_size(3);
            unsigned long long SLC = x.get_size(4);
    ...
    bool permuteROTo3rdDimensionFor3DRecon(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long N3D = RO*E1*E2;

            unsigned long long N = x.get_number_of_elements()/N3D;
            ...
            for ( n=0; n<(long long)N; n++ )
            {
                ...
                for ( unsigned long long e2=0; e2<E2; e2++ )
                {
                    for ( unsigned long long e1=0; e1<E1; e1++ )
                    {
                        for ( unsigned long long ro=0; ro<RO; ro++ )
                        {
    ...
    bool permuteROTo4thDimensionFor3DRecon(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long N4D = RO*E1*E2*CHA;

            unsigned long long N = x.get_number_of_elements()/N4D;
    ...
    bool permuteROTo1stDimensionFor3DRecon(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long E1 = x.get_size(0);
            unsigned long long E2 = x.get_size(1);
            unsigned long long CHA = x.get_size(2);
            unsigned long long RO = x.get_size(3);
            ...
            for ( n=0; n<(long long)N; n++ )
            {
                ...
                for ( cha=0; cha<(long long)CHA; cha++ )
                {
                    for ( unsigned long long e2=0; e2<E2; e2++ )
                    {
                        for ( unsigned long long e1=0; e1<E1; e1++ )
                        {
                            unsigned long long indRn = e1*RO+e2*RO*E1+cha*RO*E1*E2;
                            unsigned long long indXn = e1+e2*E1+cha*E1*E2;
                            for ( unsigned long long ro=0; ro<RO; ro++ )
                            {
    ...
    bool permuteROTo5thDimensionFor3DRecon(const hoNDArray<T>& x, hoNDArray<T>& r)
    {
        try
        {
            ...
            unsigned long long E1 = x.get_size(1);
            unsigned long long E2 = x.get_size(2);
            unsigned long long srcCHA = x.get_size(3);
            unsigned long long dstCHA = x.get_size(4);
            ...
            unsigned long long N5D = RO*E1*E2*srcCHA*dstCHA;
            ...
            for ( n=0; n<(long long)N; n++ )
            {
                ...
                {
                    for ( unsigned long long scha=0; scha<(int)srcCHA; scha++ )
                    {
                        for ( unsigned long long e2=0; e2<E2; e2++ )
                        {
                            for ( unsigned long long e1=0; e1<E1; e1++ )
                            {
                                unsigned long long indRn = e1+e2*E1+scha*E1*E2+dcha*E1*E2*srcCHA;
                                unsigned long long indXn = e1*RO+e2*RO*E1+scha*RO*E1*E2+dcha*RO*E1*E2*srcCHA;
                                for ( unsigned long long ro=0; ro<RO; ro++ )
                                {
    ...
    template EXPORTCPUCOREMATH bool multiplyOver4thDimensionExcept(const hoNDArray<float>& x4D, const hoNDArray<float>& y5D, unsigned long long n, hoNDArray<float>& r, bool copyY2R);
    template EXPORTCPUCOREMATH bool multiplyOver4thDimensionExcept(const hoNDArray<double>& x4D, const hoNDArray<double>& y5D, unsigned long long n, hoNDArray<double>& r, bool copyY2R);
    template EXPORTCPUCOREMATH bool multiplyOver4thDimensionExcept(const hoNDArray<GT_Complex8>& x4D, const hoNDArray<GT_Complex8>& y5D, unsigned long long n, hoNDArray<GT_Complex8>& r, bool copyY2R);
    template EXPORTCPUCOREMATH bool multiplyOver4thDimensionExcept(const hoNDArray<GT_Complex16>& x4D, const hoNDArray<GT_Complex16>& y5D, unsigned long long n, hoNDArray<GT_Complex16>& r, bool copyY2R);
    ...
    template EXPORTCPUCOREMATH bool multiplyOver5thDimensionExcept(const hoNDArray<float>& x, const hoNDArray<float>& y, unsigned long long n, hoNDArray<float>& r, bool copyY2R);
    template EXPORTCPUCOREMATH bool multiplyOver5thDimensionExcept(const hoNDArray<double>& x, const hoNDArray<double>& y, unsigned long long n, hoNDArray<double>& r, bool copyY2R);
    template EXPORTCPUCOREMATH bool multiplyOver5thDimensionExcept(const hoNDArray<GT_Complex8>& x, const hoNDArray<GT_Complex8>& y, unsigned long long n, hoNDArray<GT_Complex8>& r, bool copyY2R);
    template EXPORTCPUCOREMATH bool multiplyOver5thDimensionExcept(const hoNDArray<GT_Complex16>& x, const hoNDArray<GT_Complex16>& y, unsigned long long n, hoNDArray<GT_Complex16>& r, bool copyY2R);
    ...
    template EXPORTCPUCOREMATH bool cropUpTo10DArray(const hoNDArray<short>& x, hoNDArray<short>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool cropUpTo10DArray(const hoNDArray<unsigned short>& x, hoNDArray<unsigned short>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool cropUpTo10DArray(const hoNDArray<float>& x, hoNDArray<float>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool cropUpTo10DArray(const hoNDArray<double>& x, hoNDArray<double>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool cropUpTo10DArray(const hoNDArray<GT_Complex8>& x, hoNDArray<GT_Complex8>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool cropUpTo10DArray(const hoNDArray<GT_Complex16>& x, hoNDArray<GT_Complex16>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);

    template EXPORTCPUCOREMATH bool setSubArrayUpTo10DArray(const hoNDArray<short>& x, hoNDArray<short>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool setSubArrayUpTo10DArray(const hoNDArray<unsigned short>& x, hoNDArray<unsigned short>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool setSubArrayUpTo10DArray(const hoNDArray<float>& x, hoNDArray<float>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool setSubArrayUpTo10DArray(const hoNDArray<double>& x, hoNDArray<double>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool setSubArrayUpTo10DArray(const hoNDArray<GT_Complex8>& x, hoNDArray<GT_Complex8>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    template EXPORTCPUCOREMATH bool setSubArrayUpTo10DArray(const hoNDArray<GT_Complex16>& x, hoNDArray<GT_Complex16>& r, const std::vector<unsigned long long>& start, std::vector<unsigned long long>& size);
    ...
    template EXPORTCPUCOREMATH void clear<unsigned long long>( hoNDArray<unsigned long long>& );
