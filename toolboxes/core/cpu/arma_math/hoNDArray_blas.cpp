...
namespace Gadgetron{
    ...
    template<class T> long unsigned int amin( hoNDArray<T> *x )
    {
        if( x == 0x0 )
    ...
    template<class T> long unsigned int amin( hoNDArray< std::complex<T> > *x )
    {
        if( x == 0x0 )
            throw std::runtime_error("Gadgetron::amin(): Invalid input array");
    ...
    template<class T> long unsigned int amin( hoNDArray< complext<T> > *x )
    {
        if( x == 0x0 )
            throw std::runtime_error("Gadgetron::amin(): Invalid input array");
    ...
    template<class T> long unsigned int amax( hoNDArray<T> *x )
    {
        if( x == 0x0 )
    ...
    template<class T> long unsigned int amax( hoNDArray< std::complex<T> > *x )
    {
        if( x == 0x0 )
            throw std::runtime_error("Gadgetron::amax(): Invalid input array");
    ...
    template<class T> long unsigned int amax( hoNDArray< complext<T> > *x )
    {
        if( x == 0x0 )
            throw std::runtime_error("Gadgetron::amax(): Invalid input array");
    ...
    template EXPORTCPUCOREMATH long unsigned int amin<float>( hoNDArray<float>* );
    template EXPORTCPUCOREMATH long unsigned int amax<float>( hoNDArray<float>* );
    ...
    template EXPORTCPUCOREMATH long unsigned int amin<double>( hoNDArray<double>* );
    template EXPORTCPUCOREMATH long unsigned int amax<double>( hoNDArray<double>* );
    ...
    template EXPORTCPUCOREMATH long unsigned int amin<float>( hoNDArray< std::complex<float> >* );
    template EXPORTCPUCOREMATH long unsigned int amax<float>( hoNDArray< std::complex<float> >* );
    ...
    template EXPORTCPUCOREMATH long unsigned int amin<double>( hoNDArray< std::complex<double> >* );
    template EXPORTCPUCOREMATH long unsigned int amax<double>( hoNDArray< std::complex<double> >* );
    ...
    template EXPORTCPUCOREMATH long unsigned int amin<float>( hoNDArray< complext<float> >* );
    template EXPORTCPUCOREMATH long unsigned int amax<float>( hoNDArray< complext<float> >* );
    ...
    template EXPORTCPUCOREMATH long unsigned int amin<double>( hoNDArray< complext<double> >* );
    template EXPORTCPUCOREMATH long unsigned int amax<double>( hoNDArray< complext<double> >* );
