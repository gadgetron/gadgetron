...
#include "apps/gadgetron/Gadgetron.h"
...
namespace Gadgetron{
    ...
    */
    ...
    public:
        ...
        void fft(hoNDArray< ComplexType >* input, unsigned long long dim_to_transform)
        {
            //-1 refers to the sign of the transform, -1 for FFTW_FORWARD
            fft_int(input,dim_to_transform,-1);
        }

        void ifft(hoNDArray< ComplexType >* input, unsigned long long dim_to_transform)
        {
        ...
        {
            for (unsigned long long i = 0; i < input->get_number_of_dimensions(); i++) {
                //-1 refers to the sign of the transform, -1 for FFTW_FORWARD
                fft_int(input,i,-1);
            }
        }
    ...
    protected:
        ...
        void fft_int(hoNDArray< ComplexType >* input, unsigned long long dim_to_transform, int sign);
        ...
        unsigned long long fftshiftPivot(unsigned long long len);
        unsigned long long ifftshiftPivot(unsigned long long len);

        // 1D
        bool fftshift1D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long pivot);
        bool ifftshift1D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long pivot);

        bool fftshiftPivot1D(ComplexType* a, unsigned long long x, unsigned long long n, unsigned long long pivot);
        bool fftshiftPivot1D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long n, unsigned long long pivot);

        // 2D
        bool fftshiftPivot2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n, unsigned pivotx, unsigned pivoty);
        bool fftshiftPivot2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n, unsigned pivotx, unsigned pivoty);

        bool fftshift2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n);
        bool ifftshift2D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long n);

        bool fftshift2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n);
        bool ifftshift2D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long n);

        // 3D
        bool fftshiftPivot3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n, unsigned pivotx, unsigned pivoty, unsigned pivotz);
        bool fftshiftPivot3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n, unsigned pivotx, unsigned pivoty, unsigned pivotz);

        bool fftshift3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n);
        bool ifftshift3D(const ComplexType* a, ComplexType* r, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n);

        bool fftshift3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n);
        bool ifftshift3D(ComplexType* a, unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long n);
        ...
        bool configureFFTHandle(long long NDim, MKL_LONG* dim, DFTI_CONFIG_VALUE fftPresion, unsigned long long n, DFTI_DESCRIPTOR_HANDLE& handle);
        bool configureFFTHandleOutOfPlace(long long NDim, MKL_LONG* dim, DFTI_CONFIG_VALUE fftPresion, unsigned long long n, DFTI_DESCRIPTOR_HANDLE& handle);
