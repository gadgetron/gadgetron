...
public:
    ...
    T& operator()( const std::vector<long long>& ind ) { return (*this)( (size_t)ind[0], (size_t)ind[1]); }
    const T& operator()( const std::vector<long long>& ind ) const { return (*this)( (size_t)ind[0], (size_t)ind[1]); }
