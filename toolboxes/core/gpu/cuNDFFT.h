...
namespace Gadgetron{
  ...
  */
  ...
  public:
    ...
    void fft ( cuNDArray<complext<T> > *input, std::vector<unsigned long long> *dims_to_transform );
    void ifft( cuNDArray<complext<T> > *input, std::vector<unsigned long long> *dims_to_transform, bool do_scale = true );
  ...
  protected:
    void fft_int( cuNDArray<complext<T> > *input, std::vector<unsigned long long> *dims_to_transform, int direction, bool do_scale = true );
  };
}
