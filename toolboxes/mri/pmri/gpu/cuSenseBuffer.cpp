...
namespace Gadgetron {
  ...
  template class cuSenseBuffer<float,2>;
  template class cuSenseBuffer<float,3>;
  template class cuSenseBuffer<float,4>;
  template class cuSenseBuffer<double,2>;
  template class cuSenseBuffer<double,3>;
  template class cuSenseBuffer<double,4>;
}
