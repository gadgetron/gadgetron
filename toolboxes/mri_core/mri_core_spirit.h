...
namespace Gadgetron {
    ...
    template <typename T> EXPORTMRICORE void spirit3d_calib(const hoNDArray<T>& acsSrc, const hoNDArray<T>& acsDst,
    ...
    template <typename T> EXPORTMRICORE void spirit3d_convert_to_convolution_kernel(const hoNDArray<T>& ker, size_t kRO, size_t kE1, size_t kE2, size_t oRO, size_t oE1, size_t oE2, hoNDArray<T>& convKer, bool minusI = false);
    ...
    template <typename T> EXPORTMRICORE void spirit_image_domain_adjoint_kernel(const hoNDArray<T>& kIm, hoNDArray<T>& adjkIm);

    /// compute the (G-I)'*(G-I)
    template <typename T> EXPORTMRICORE void spirit_adjoint_forward_kernel(const hoNDArray<T>& kImS2D, const hoNDArray<T>& kImD2S, hoNDArray<T>& kIm);
}
