...
template <class T> void Gadgetron::cuNCGSolver<T>::
...
template class EXPORTGPUSOLVERS Gadgetron::cuNCGSolver<float>;
template class EXPORTGPUSOLVERS Gadgetron::cuNCGSolver<double>;

template class EXPORTGPUSOLVERS Gadgetron::cuNCGSolver< complext<float> >;
template class EXPORTGPUSOLVERS Gadgetron::cuNCGSolver< complext<double> >;
