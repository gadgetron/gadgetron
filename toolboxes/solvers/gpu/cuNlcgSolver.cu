...
template <class T> void Gadgetron::cuNlcgSolver<T>::
...
template class EXPORTGPUSOLVERS Gadgetron::cuNlcgSolver<float>;
template class EXPORTGPUSOLVERS Gadgetron::cuNlcgSolver<double>;

template class EXPORTGPUSOLVERS Gadgetron::cuNlcgSolver< complext<float> >;
template class EXPORTGPUSOLVERS Gadgetron::cuNlcgSolver< complext<double> >;
