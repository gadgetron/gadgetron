...
class sbSolver : public solver<ARRAY_TYPE_ELEMENT, ARRAY_TYPE_ELEMENT>
{
public:
...
protected:
		     ...
		     boost::shared_array< boost::shared_ptr<ARRAY_TYPE_ELEMENT> > &b_k )
  {
    ...
    if( tolerance > get_zero<REAL>() || this->output_mode_ >= solver<ARRAY_TYPE_ELEMENT, ARRAY_TYPE_ELEMENT>::OUTPUT_VERBOSE ){
      u_k_prev = *u_k;
