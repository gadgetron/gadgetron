...
#pragma omp parallel for default(none) private(n) shared(N, x, y, r) if (N>64*1024)
    ...
    template EXPORTGTPLUS void compute_number_of_eigen_modes_kept(const hoNDArray<float>& eigenValues, double thres, size_t& numOfModesKept);
    template EXPORTGTPLUS void compute_number_of_eigen_modes_kept(const hoNDArray<double>& eigenValues, double thres, size_t& numOfModesKept);
    template EXPORTGTPLUS void compute_number_of_eigen_modes_kept(const hoNDArray< std::complex<float> >& eigenValues, double thres, size_t& numOfModesKept);
    template EXPORTGTPLUS void compute_number_of_eigen_modes_kept(const hoNDArray< std::complex<double> >& eigenValues, double thres, size_t& numOfModesKept);
    ...
    template EXPORTGTPLUS void prune_eigen_vector_matrix(const hoNDArray<float>& eigenVectors, size_t numOfModesKept, hoNDArray<float>& eigenVectorsPruned);
    template EXPORTGTPLUS void prune_eigen_vector_matrix(const hoNDArray<double>& eigenVectors, size_t numOfModesKept, hoNDArray<double>& eigenVectorsPruned);
    template EXPORTGTPLUS void prune_eigen_vector_matrix(const hoNDArray< std::complex<float> >& eigenVectors, size_t numOfModesKept, hoNDArray< std::complex<float> >& eigenVectorsPruned);
    template EXPORTGTPLUS void prune_eigen_vector_matrix(const hoNDArray< std::complex<double> >& eigenVectors, size_t numOfModesKept, hoNDArray< std::complex<double> >& eigenVectorsPruned);
    ...
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_2D(const hoNDArray<float>& data, double thres, hoNDArray<float>& coeff, hoNDArray<float>& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_2D(const hoNDArray<double>& data, double thres, hoNDArray<double>& coeff, hoNDArray<double>& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_2D(const hoNDArray< std::complex<float> >& data, double thres, hoNDArray< std::complex<float> >& coeff, hoNDArray< std::complex<float> >& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_2D(const hoNDArray< std::complex<double> >& data, double thres, hoNDArray< std::complex<double> >& coeff, hoNDArray< std::complex<double> >& eigenValues);
    ...
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_2D(const hoNDArray<float>& data, size_t numOfModesKept, hoNDArray<float>& coeff, hoNDArray<float>& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_2D(const hoNDArray<double>& data, size_t numOfModesKept, hoNDArray<double>& coeff, hoNDArray<double>& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_2D(const hoNDArray< std::complex<float> >& data, size_t numOfModesKept, hoNDArray< std::complex<float> >& coeff, hoNDArray< std::complex<float> >& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_2D(const hoNDArray< std::complex<double> >& data, size_t numOfModesKept, hoNDArray< std::complex<double> >& coeff, hoNDArray< std::complex<double> >& eigenValues);
    ...
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_3D(const hoNDArray<float>& data, double thres, hoNDArray<float>& coeff, hoNDArray<float>& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_3D(const hoNDArray<double>& data, double thres, hoNDArray<double>& coeff, hoNDArray<double>& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_3D(const hoNDArray< std::complex<float> >& data, double thres, hoNDArray< std::complex<float> >& coeff, hoNDArray< std::complex<float> >& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_3D(const hoNDArray< std::complex<double> >& data, double thres, hoNDArray< std::complex<double> >& coeff, hoNDArray< std::complex<double> >& eigenValues);
    ...
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_3D(const hoNDArray<float>& data, size_t numOfModesKept, hoNDArray<float>& coeff, hoNDArray<float>& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_3D(const hoNDArray<double>& data, size_t numOfModesKept, hoNDArray<double>& coeff, hoNDArray<double>& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_3D(const hoNDArray< std::complex<float> >& data, size_t numOfModesKept, hoNDArray< std::complex<float> >& coeff, hoNDArray< std::complex<float> >& eigenValues);
    template EXPORTGTPLUS void compute_KLT_coil_compression_coeff_3D(const hoNDArray< std::complex<double> >& data, size_t numOfModesKept, hoNDArray< std::complex<double> >& coeff, hoNDArray< std::complex<double> >& eigenValues);
...
#pragma omp parallel for default(none) private(n) shared(N, RO, E1, CHA, dstCHA, data, dataEigen, coeff) if(N>1)
    ...
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_2D(const hoNDArray<float>& data, const hoNDArray<float>& coeff, hoNDArray<float>& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_2D(const hoNDArray<double>& data, const hoNDArray<double>& coeff, hoNDArray<double>& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_2D(const hoNDArray< std::complex<float> >& data, const hoNDArray< std::complex<float> >& coeff, hoNDArray< std::complex<float> >& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_2D(const hoNDArray< std::complex<double> >& data, const hoNDArray< std::complex<double> >& coeff, hoNDArray< std::complex<double> >& dataEigen);
...
#pragma omp parallel for default(none) private(n) shared(N, RO, E1, E2, CHA, dstCHA, data, dataEigen, coeff) if(N>1)
    ...
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_3D(const hoNDArray<float>& data, const hoNDArray<float>& coeff, hoNDArray<float>& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_3D(const hoNDArray<double>& data, const hoNDArray<double>& coeff, hoNDArray<double>& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_3D(const hoNDArray< std::complex<float> >& data, const hoNDArray< std::complex<float> >& coeff, hoNDArray< std::complex<float> >& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_3D(const hoNDArray< std::complex<double> >& data, const hoNDArray< std::complex<double> >& coeff, hoNDArray< std::complex<double> >& dataEigen);
    ...
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_2D(const hoNDArray<float>& data, const std::vector< hoNDArray<float> >& coeff, hoNDArray<float>& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_2D(const hoNDArray<double>& data, const std::vector< hoNDArray<double> >& coeff, hoNDArray<double>& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_2D(const hoNDArray< std::complex<float> >& data, const std::vector< hoNDArray< std::complex<float> > >& coeff, hoNDArray< std::complex<float> >& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_2D(const hoNDArray< std::complex<double> >& data, const std::vector< hoNDArray< std::complex<double> > >& coeff, hoNDArray< std::complex<double> >& dataEigen);
    ...
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_3D(const hoNDArray<float>& data, const std::vector< hoNDArray<float> >& coeff, hoNDArray<float>& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_3D(const hoNDArray<double>& data, const std::vector< hoNDArray<double> >& coeff, hoNDArray<double>& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_3D(const hoNDArray< std::complex<float> >& data, const std::vector< hoNDArray< std::complex<float> > >& coeff, hoNDArray< std::complex<float> >& dataEigen);
    template EXPORTGTPLUS void appy_KLT_coil_compression_coeff_3D(const hoNDArray< std::complex<double> >& data, const std::vector< hoNDArray< std::complex<double> > >& coeff, hoNDArray< std::complex<double> >& dataEigen);
    ...
    template EXPORTGTPLUS void compute_KLT_filter(const hoNDArray<float>& data, size_t numOfModesKept, hoNDArray<float>& dataKLF);
    template EXPORTGTPLUS void compute_KLT_filter(const hoNDArray<double>& data, size_t numOfModesKept, hoNDArray<double>& dataKLF);
    template EXPORTGTPLUS void compute_KLT_filter(const hoNDArray< std::complex<float> >& data, size_t numOfModesKept, hoNDArray< std::complex<float> >& dataKLF);
    template EXPORTGTPLUS void compute_KLT_filter(const hoNDArray< std::complex<double> >& data, size_t numOfModesKept, hoNDArray< std::complex<double> >& dataKLF);
