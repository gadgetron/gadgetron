...
protected:
    virtual void SetUp()
    {
        ...
        GADGET_MSG_DEPRECATED("=============================================================================================");
        GADGET_MSG_DEPRECATED("Unit Test for GtPlus");
        gtPluse_ut_data_folder_ = gtPluse_ut_folder_ + "/data/";
        gtPluse_ut_res_folder_ = gtPluse_ut_folder_ + "/result/";
        GADGET_MSG_DEPRECATED("gtPluse_ut_data_folder_ is " << gtPluse_ut_data_folder_);
        GADGET_MSG_DEPRECATED("gtPluse_ut_res_folder_ is " << gtPluse_ut_res_folder_);
...
TYPED_TEST(gtPlus_grappa_Test, reconWorker2DTGRAPPA_SNRUnit)
{
    ...
    GADGET_MSG_DEPRECATED("kspace = " << v);
    ...
    GADGET_MSG_DEPRECATED("[Ro E1 Cha Slice E2 Con Phase Rep Set Seg] = [" 
...
TYPED_TEST(gtPlus_grappa_Test, reconWorker2DTGRAPPA)
{
    ...
    Gadgetron::norm2(workOrder->data_, v); GADGET_MSG_DEPRECATED("workOrder->data_ = " << v);
    Gadgetron::norm2(workOrder->ref_, v); GADGET_MSG_DEPRECATED("workOrder->ref_ = " << v);
...
TYPED_TEST(gtPlus_grappa_Test, grappa2D)
{
    ...
    GADGET_MSG_DEPRECATED("acsSrc = " << v);
