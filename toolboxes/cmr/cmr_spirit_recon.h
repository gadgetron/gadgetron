...
namespace Gadgetron { 
    ...
    template <typename T> EXPORTCMR void perform_spirit_recon_linear_2DT(const Gadgetron::hoNDArray<T>& kspace, size_t startE1, size_t endE1, const Gadgetron::hoNDArray<T>& kerIm, const Gadgetron::hoNDArray<T>& kspaceInitial, Gadgetron::hoNDArray<T>& res, size_t iter_max=90, double iter_thres=0.0015, bool print_iter=false);
