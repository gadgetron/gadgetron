...
namespace Gadgetron {
	...
	template <typename T> EXPORTCMR void compute_analytical_strain(const hoNDArray<T>& dx, const hoNDArray<T>& dy, const hoNDArray<T>& mask, hoNDArray<T>& rad_strain, hoNDArray<T>& circ_strain);
}
