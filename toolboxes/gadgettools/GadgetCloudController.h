...
public:
    ...
    int createConnector(const CloudType& cloud, 
        unsigned long long msgID_reader, std::vector<GadgetMessageReader*>& readers, 
        unsigned long long msgID_writer, std::vector<GadgetMessageWriter*>& writers);
...
private:
    ...
    unsigned long long cloud_msg_id_reader_;
    unsigned long long cloud_msg_id_writer_;
