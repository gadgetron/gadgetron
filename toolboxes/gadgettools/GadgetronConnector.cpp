...
int GadgetronConnector::register_reader(unsigned long long slot, GadgetMessageReader *reader)
{
    return readers_.insert(slot,reader);
}

/*
int GadgetronConnector::register_writer(unsigned long long slot, GadgetMessageWriter *writer)
{
