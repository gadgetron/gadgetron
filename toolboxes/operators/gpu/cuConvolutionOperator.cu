...
namespace Gadgetron {
  ...
  template class cuConvolutionOperator<float,1>;
  template class cuConvolutionOperator<float,2>;
  template class cuConvolutionOperator<float,3>;
  template class cuConvolutionOperator<float,4>;

  template class cuConvolutionOperator<double,1>;
  template class cuConvolutionOperator<double,2>;
  template class cuConvolutionOperator<double,3>;
  template class cuConvolutionOperator<double,4>;
