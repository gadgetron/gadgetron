...
namespace Gadgetron{
  ...
  template class cuPartialDerivativeOperator<float, 1>;
  template class cuPartialDerivativeOperator<float, 2>;
  template class cuPartialDerivativeOperator<float, 3>;
  template class cuPartialDerivativeOperator<float, 4>;
  template class cuPartialDerivativeOperator<float, 5>;

  template class cuPartialDerivativeOperator<float_complext, 1>;
  template class cuPartialDerivativeOperator<float_complext, 2>;
  template class cuPartialDerivativeOperator<float_complext, 3>;
  template class cuPartialDerivativeOperator<float_complext, 4>;
  template class cuPartialDerivativeOperator<float_complext, 5>;

  template class cuPartialDerivativeOperator<double, 1>;
  template class cuPartialDerivativeOperator<double, 2>;
  template class cuPartialDerivativeOperator<double, 3>;
  template class cuPartialDerivativeOperator<double, 4>;
  template class cuPartialDerivativeOperator<double, 5>;

  template class cuPartialDerivativeOperator<double_complext, 1>;
  template class cuPartialDerivativeOperator<double_complext, 2>;
  template class cuPartialDerivativeOperator<double_complext, 3>;
  template class cuPartialDerivativeOperator<double_complext, 4>;
  template class cuPartialDerivativeOperator<double_complext, 5>;
}
