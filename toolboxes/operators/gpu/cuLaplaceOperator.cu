...
namespace Gadgetron{
  ...
  template class cuLaplaceOperator<float, 1>;
  template class cuLaplaceOperator<float, 2>;
  template class cuLaplaceOperator<float, 3>;

  template class cuLaplaceOperator<float_complext, 1>;
  template class cuLaplaceOperator<float_complext, 2>;
  template class cuLaplaceOperator<float_complext, 3>;

  template class cuLaplaceOperator<double, 1>;
  template class cuLaplaceOperator<double, 2>;
  template class cuLaplaceOperator<double, 3>;

  template class cuLaplaceOperator<double_complext, 1>;
  template class cuLaplaceOperator<double_complext, 2>;
  template class cuLaplaceOperator<double_complext, 3>;
}
