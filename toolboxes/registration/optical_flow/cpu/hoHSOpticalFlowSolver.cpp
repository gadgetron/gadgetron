...
#pragma omp parallel for
  ...
  template class hoHSOpticalFlowSolver<float,1>;
  template class hoHSOpticalFlowSolver<float,2>;
  template class hoHSOpticalFlowSolver<float,3>;
  template class hoHSOpticalFlowSolver<float,4>;

  template class hoHSOpticalFlowSolver<double,1>;
  template class hoHSOpticalFlowSolver<double,2>;
  template class hoHSOpticalFlowSolver<double,3>;
  template class hoHSOpticalFlowSolver<double,4>;
}
