...
namespace Gadgetron{
  ...
  template class hoOpticalFlowSolver<float,1>;
  template class hoOpticalFlowSolver<float,2>;
  template class hoOpticalFlowSolver<float,3>;
  template class hoOpticalFlowSolver<float,4>;

  template class hoOpticalFlowSolver<double,1>;
  template class hoOpticalFlowSolver<double,2>;
  template class hoOpticalFlowSolver<double,3>;
  template class hoOpticalFlowSolver<double,4>;
}
