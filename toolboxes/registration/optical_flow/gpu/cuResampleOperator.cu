...
namespace Gadgetron{
  ...
  template class cuResampleOperator<float,1>;
  template class cuResampleOperator<float_complext,1>;

  template class cuResampleOperator<float,2>;
  template class cuResampleOperator<float_complext,2>;

  template class cuResampleOperator<float,3>;
  template class cuResampleOperator<float_complext,3>;

  template class cuResampleOperator<float,4>;
  template class cuResampleOperator<float_complext,4>;

  template class cuResampleOperator<double,1>;
  template class cuResampleOperator<double_complext,1>;

  template class cuResampleOperator<double,2>;
  template class cuResampleOperator<double_complext,2>;

  template class cuResampleOperator<double,3>;
  template class cuResampleOperator<double_complext,3>;

  template class cuResampleOperator<double,4>;
  template class cuResampleOperator<double_complext,4>;
}
