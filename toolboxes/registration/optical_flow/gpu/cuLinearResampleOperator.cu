...
namespace Gadgetron{
  ...
  template class cuLinearResampleOperator<float,1>;
  template class cuLinearResampleOperator<float_complext,1>;

  template class cuLinearResampleOperator<float,2>;
  template class cuLinearResampleOperator<float_complext,2>;

  template class cuLinearResampleOperator<float,3>;
  template class cuLinearResampleOperator<float_complext,3>;

  template class cuLinearResampleOperator<float,4>;
  template class cuLinearResampleOperator<float_complext,4>;

  template class cuLinearResampleOperator<double,1>;
  template class cuLinearResampleOperator<double_complext,1>;

  template class cuLinearResampleOperator<double,2>;
  template class cuLinearResampleOperator<double_complext,2>;

  template class cuLinearResampleOperator<double,3>;
  template class cuLinearResampleOperator<double_complext,3>;

  template class cuLinearResampleOperator<double,4>;
  template class cuLinearResampleOperator<double_complext,4>;
}
