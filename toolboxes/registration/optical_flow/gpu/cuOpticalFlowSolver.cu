...
namespace Gadgetron{
  ...
  template class cuOpticalFlowSolver<float,1>;
  template class cuOpticalFlowSolver<float,2>;
  template class cuOpticalFlowSolver<float,3>;
  template class cuOpticalFlowSolver<float,4>;

  template class cuOpticalFlowSolver<double,1>;
  template class cuOpticalFlowSolver<double,2>;
  template class cuOpticalFlowSolver<double,3>;
  template class cuOpticalFlowSolver<double,4>;
}
