...
namespace Gadgetron{
  ...
  template class cuHSOpticalFlowSolver<float,1>;
  template class cuHSOpticalFlowSolver<float,2>;
  template class cuHSOpticalFlowSolver<float,3>;
  template class cuHSOpticalFlowSolver<float,4>;

  template class cuHSOpticalFlowSolver<double,1>;
  template class cuHSOpticalFlowSolver<double,2>;
  template class cuHSOpticalFlowSolver<double,3>;
  template class cuHSOpticalFlowSolver<double,4>;
}
