...
RUN apt-get update --quiet && \
    ...
    apt-utils wget build-essential python3-dev python3-pip libhdf5-serial-dev cmake git-core \
    libfftw3-dev jq libzmq-dev \
    liblapack-dev libxml2-dev libfreetype6-dev pkg-config \
