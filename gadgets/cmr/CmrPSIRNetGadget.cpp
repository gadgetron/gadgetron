        ...
        try
        {
            ...
            for (slc=0; slc<SLC; slc++)
            {
                for (n=0; n<N; n++)
                {
                    ...
                    res_psir.headers_(n, 0, slc).image_series_index = 111;
                    res_psir.headers_(n, 0, slc).image_index = n + slc*N + 1;
                    ...
                    res_magir.headers_(n, 0, slc).image_series_index = 109;
                    res_magir.headers_(n, 0, slc).image_index = n + slc*N + 1;
