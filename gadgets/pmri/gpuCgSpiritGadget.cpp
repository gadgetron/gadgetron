...
namespace Gadgetron{
  ...
  int gpuCgSpiritGadget::process_config(const mrd::Header& header)
  {
  ...
  int gpuCgSpiritGadget::process(GadgetContainerMessage<mrd::ImageHeader> *m1, GadgetContainerMessage<GenericReconJob> *m2)
  {
