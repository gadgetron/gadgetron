#include "UnifiedFFTGadget.h"
#include "hoNDFFT.h"

namespace Gadgetron{

UnifiedFFTGadget::UnifiedFFTGadget()
  : image_counter_(0)
{
...
int UnifiedFFTGadget::process( GadgetContainerMessage<IsmrmrdReconData>* m1)
{
...
GADGET_FACTORY_DECLARE(UnifiedFFTGadget)
}
