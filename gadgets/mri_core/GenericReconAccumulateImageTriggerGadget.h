...
public:
    ...
    GADGET_PROPERTY(trigger_channel       , bool, "Whether to trigger along channel", false);
    GADGET_PROPERTY(trigger_slice         , bool, "Whether to trigger along slice", false);
    GADGET_PROPERTY(trigger_contrast      , bool, "Whether to trigger along contrast", false);
    GADGET_PROPERTY(trigger_phase         , bool, "Whether to trigger along phase", false);
    GADGET_PROPERTY(trigger_repetition    , bool, "Whether to trigger along repetition", false);
    GADGET_PROPERTY(trigger_set           , bool, "Whether to trigger along set", false);
    GADGET_PROPERTY(trigger_average       , bool, "Whether to trigger along average", false);
    GADGET_PROPERTY(pass_image_immediately, bool, "Whether to pass image immediately", false);
