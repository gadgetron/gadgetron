...
namespace Gadgetron {
    ...
    protected:
        ...
        virtual size_t compute_image_number(const ISMRMRD::ImageHeader& imheader, size_t encoding = 0, size_t CHA = 1, size_t cha = 0, size_t E2 = 1);
        ...
        virtual int send_out_image_array(IsmrmrdImageArray& res, size_t encoding, int series_num, const std::string& data_role);

        virtual ~ImageArraySendMixin() = default;
