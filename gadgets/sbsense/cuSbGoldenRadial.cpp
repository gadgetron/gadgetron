...
namespace Gadgetron{
  ...
  cuSbGoldenRadialGadget::calculate_trajectory()
  {
    // Define trajectories
  ...
  cuSbGoldenRadialGadget::calculate_density_compensation()
  {
  ...
  GADGET_FACTORY_DECLARE(cuSbGoldenRadialGadget)
}
