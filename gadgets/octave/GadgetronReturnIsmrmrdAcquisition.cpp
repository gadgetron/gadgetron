	   ...
	   "GadgetronReturnIsmrmrdAcquisition Returns Acquisition to the Gadgetron")
{
  ...
  if (nargin != 3) {
    ...
    head->quaternion[0] = octave_value(h.contents("quaternion")(0)).float_array_value()(0);
    head->quaternion[1] = octave_value(h.contents("quaternion")(0)).float_array_value()(1);
    head->quaternion[2] = octave_value(h.contents("quaternion")(0)).float_array_value()(2);
    head->quaternion[3] = octave_value(h.contents("quaternion")(0)).float_array_value()(3);
