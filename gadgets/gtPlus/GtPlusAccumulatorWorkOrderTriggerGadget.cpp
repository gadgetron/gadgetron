...
int GtPlusAccumulatorWorkOrderTriggerGadget::process_config(ACE_Message_Block* mb)
{
    ...
    workOrder_.acceFactorE1_ = (unsigned long long)(p_imaging.accelerationFactor().kspace_encoding_step_1());
    workOrder_.acceFactorE2_ = (unsigned long long)(p_imaging.accelerationFactor().kspace_encoding_step_2());
...
int GtPlusAccumulatorWorkOrderTriggerGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader>* m1, GadgetContainerMessage< hoNDArray< std::complex<float> > >* m2)
{
    ...
    unsigned long long scan_counter = m1->getObjectPtr()->scan_counter;
    ...
    if ( bIsOther )
    {
        ...
        if ( other_kspace_matching_Dim_ != DIM_NONE )
        {
            ...
            {
                unsigned long long v = getDimValue(prev_acq_header_, other_kspace_matching_Dim_);
...
bool GtPlusAccumulatorWorkOrderTriggerGadget::storeImageData(GadgetContainerMessage<ISMRMRD::AcquisitionHeader>* m1, GadgetContainerMessage< hoNDArray< std::complex<float> > >* m2, bool isReflect)
{
    try
    {
        ...
        if ( workOrder_.data_.get_number_of_elements() <= 0 )
        {
            ...
            unsigned long long N = dimensions_.size();
            for ( ii=0; ii<N; ii++ )
            {
            ...
            try
            {
                ...
                std::vector<unsigned long long> reflect_dimensions_(dimensions_);
        ...
        std::vector<unsigned long long> pos(10);
...
storeRefData(GadgetContainerMessage<ISMRMRD::AcquisitionHeader>* m1, GadgetContainerMessage< hoNDArray< std::complex<float> > >* m2, bool isReflect)
{
    try
    {
        ...
        if ( workOrder_.ref_.get_number_of_elements() <= 0 )
        {
            ...
            unsigned long long RO = meas_max_ro_;
...
fillBuffer(ReadOutBufferType& readOutBuffer, BufferType& buf, ReflectBufferType& reflectBuf)
{
    try
    {
        ...
        unsigned long long numOfReadOuts = readOutBuffer.size();
        ...
        try
        {
            ...
            std::vector<unsigned long long> reflect_dims(dims);
            reflect_dims[0] = 1;
            reflect_dims[2] = 1;
...
unsigned long long GtPlusAccumulatorWorkOrderTriggerGadget::
computeEncodedSizeE1(unsigned long long centerE1, unsigned long long maxE1)
{
    int E1;
    if ( (maxE1+1)%2 == 0 )
    {
...
unsigned long long GtPlusAccumulatorWorkOrderTriggerGadget::
computeEncodedSizeE2(unsigned long long centerE2, unsigned long long maxE2)
{
    int E2;
    if ( (maxE2+1)%2 == 0 )
    {
...
bool GtPlusAccumulatorWorkOrderTriggerGadget::
triggerByDimEqual(Gadgetron::gtPlus::ISMRMRDDIM& triggerDim, unsigned long long value, bool workFlow_BufferKernel_, bool workFlow_use_BufferedKernel_)
{
    try
    {
...
bool GtPlusAccumulatorWorkOrderTriggerGadget::
triggerByDimLessEqual(Gadgetron::gtPlus::ISMRMRDDIM& triggerDim, unsigned long long value, bool workFlow_BufferKernel_, bool workFlow_use_BufferedKernel_)
{
    try
    {
        GADGET_CONDITION_MSG(verboseMode_, "GtPlusAccumulatorWorkOrderTriggerGadget - triggerByDimEqual(triggerDim, value) ... ");
...
bool GtPlusAccumulatorWorkOrderTriggerGadget::
triggerByDimEqual(Gadgetron::gtPlus::ISMRMRDDIM& triggerDim1, unsigned long long value1, Gadgetron::gtPlus::ISMRMRDDIM& triggerDim2, unsigned long long value2, bool workFlow_BufferKernel_, bool workFlow_use_BufferedKernel_)
{
    try
    {
...
bool GtPlusAccumulatorWorkOrderTriggerGadget::
triggerByDim1LessEqualDim2Equal(Gadgetron::gtPlus::ISMRMRDDIM& triggerDim1, unsigned long long value1, Gadgetron::gtPlus::ISMRMRDDIM& triggerDim2, unsigned long long value2, bool workFlow_BufferKernel_, bool workFlow_use_BufferedKernel_)
{
    try
    {
...
setDimValue(ISMRMRD::AcquisitionHeader& acqHeader, Gadgetron::gtPlus::ISMRMRDDIM& dim, unsigned long long value)
{
