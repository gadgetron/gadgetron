...
void GtPlusGadgetImageExt::set_matrix_size(unsigned long long index, ACE_UINT16 size)
{
    if (index < 3) 
    {
...
extractGadgetImageArrayEqual(Gadgetron::gtPlus::ISMRMRDDIM& dim, unsigned long long value, GtPlusGadgetImageArray& imageArray)
{
    try
    {
        int dimInd;
        ...
        unsigned long long startInd[7];
        unsigned long long endInd[7];
...
bool GtPlusGadgetImageArray::
extractGadgetImageArrayEqual(Gadgetron::gtPlus::ISMRMRDDIM& dim1, unsigned long long value1, Gadgetron::gtPlus::ISMRMRDDIM& dim2, unsigned long long value2, GtPlusGadgetImageArray& imageArray)
{
    try
    {
        int dimInd1;
...
bool GtPlusGadgetImageArray::
extractGadgetImageArrayLessEqual(Gadgetron::gtPlus::ISMRMRDDIM& dim, unsigned long long value, GtPlusGadgetImageArray& imageArray)
{
    try
    {
        int dimInd;
...
bool GtPlusGadgetImageArray::
extractGadgetImageArray_Dim1LessEqual_Dim2Equal(Gadgetron::gtPlus::ISMRMRDDIM& dim1, unsigned long long value1, 
        Gadgetron::gtPlus::ISMRMRDDIM& dim2, unsigned long long value2, GtPlusGadgetImageArray& imageArray)
{
    try
    {
        int dimInd1;
...
bool GtPlusGadgetImageArray::
getSubImageArray(unsigned long long* startInd, unsigned long long* endInd, GtPlusGadgetImageArray& imageArray)
{
    try
    {
        int aSize[10];
        ...
        unsigned long long slc, e2, con, phs, rep, set, seg;
