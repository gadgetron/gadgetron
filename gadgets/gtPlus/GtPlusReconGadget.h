...
public:
    ...
    unsigned long long min_intensity_value_;
    unsigned long long max_intensity_value_;

    // maximal intensity value when converted to unsigned short
    unsigned long long max_intensity_value_US_;
    ...
    int computeSeriesImageNumber (ISMRMRD::ImageHeader& imheader, unsigned long long nCHA=1, unsigned long long cha=0, unsigned long long nE2=1, unsigned long long e2=0);
    ...
    bool findStartingDimIndex(const std::vector<DimensionRecordType>& dimStartingIndexes, Gadgetron::gtPlus::ISMRMRDDIM& dim, unsigned long long ind);
...
public:
    ...
    unsigned long long num_acq_channels_;
    ...
    unsigned long long reconE1_;
    unsigned long long reconE2_;
    ...
    unsigned long long kSpaceMaxAcqE1No_;
    unsigned long long kSpaceMaxAcqE2No_;
