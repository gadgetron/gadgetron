...
if (MKL_FOUND)
    ...
    if (EXISTS "${MKLROOT_PATH}/compiler/lib/intel64")
        set(MKL_COMPILER_LIB_DIR "${MKLROOT_PATH}/compiler/lib/intel64")
    else ()
        if (WIN32)
            if (EXISTS "${MKLROOT_PATH}/compiler/lib/intel64_win")
                set(MKL_COMPILER_LIB_DIR "${MKLROOT_PATH}/compiler/lib/intel64_win")
            endif()
        else ()
            if (EXISTS "${MKLROOT_PATH}/compiler/lib/intel64_lin")
                    set(MKL_COMPILER_LIB_DIR "${MKLROOT_PATH}/compiler/lib/intel64_lin")
            endif()
        endif()
    endif()
