...
if (WIN32)
    ...
    set(MKL_PATH ${MKLROOT_PATH}/mkl)
else ()
    #set(MKLROOT_PATH "/opt/intel" CACHE PATH "Where the MKL are stored")
    find_path(MKL_PATH "include/mkl.h" PATHS /usr/local ${MKLROOT_PATH}/mkl)
endif ()
...
if (MKL_FOUND)
    ...
    if(WIN32)
        find_path(MKL_LIB_DIR "mkl_core.lib" PATHS ${MKL_PATH}/lib ${MKL_PATH}/lib/intel64)
    else (WIN32)
        find_path(MKL_LIB_DIR "libmkl_core.so" PATHS ${MKL_PATH}/lib ${MKL_PATH}/lib/intel64)
    endif (WIN32)
    ...
    if (MKL_COMPILER_LIB_DIR)
        ...
        set(MKL_COMPILER_LIB_DIR ${MKL_LIB_DIR})
