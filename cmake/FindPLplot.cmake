...
if (EXISTS ${PLPLOT_PATH}/plplot)
    ...
    if (EXISTS /usr/local/include/plplot)
      set(PLPLOT_PATH /usr/local/include)
      set(PLPLOT_FOUND TRUE)
      message("PLplot is found at ${PLPLOT_PATH}/plplot")
    else()
...
if (PLPLOT_FOUND)
    ...
    message("PLPLOT_INCLUDE_DIR is ${PLPLOT_INCLUDE_DIR}")
    message("PLPLOT_LIB_DIR is ${PLPLOT_LIB_DIR}")
    message("PLPLOT_LIBRARIES is ${PLPLOT_LIBRARIES}")
