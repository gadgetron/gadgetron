...
if( "${CUDA_COMPUTE_CAPABILITY}" MATCHES ALL)
  if (${CUDA_VERSION_MAJOR} VERSION_GREATER "6")
    set(CUDA_NVCC_FLAGS ${CUDA_NVCC_FLAGS} ${CUDA_NVCC_FLAGS2} ${CUDA_NVCC_FLAGS3} ${CUDA_NVCC_FLAGS4} ${CUDA_NVCC_FLAGS5} ${CUDA_NVCC_FLAGS52} ${CUDA_NVCC_FLAGS6} ${CUDA_NVCC_FLAGS61} )
  else()
