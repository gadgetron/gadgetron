...
if [ $(id -u) -ne 0 ]; then
  ...
  if [ $# -ge 4 ]; then
    ...
    chroot ${MOUNT_POINT}/chroot-root/gadgetron /home/javeda2/anaconda3/envs/gadgetron/share/gadgetron/chroot/siemens_to_ismrmrd.sh $DAT_FILENAME $ISMRMRD_FILENAME $SCAN_NO
    exit $?
  else
