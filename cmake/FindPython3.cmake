...
#
    if(NOT DEFINED ENV{PYTHON3_LIB_PATH})
        set(PYTHON3_LIB_PATH "/usr/lib/x86_64-linux-gnu" CACHE PATH "Where the python 3 are stored")
    else()
        message("PYTHON3_LIB_PATH is set as the corresponding environmental variable ... ")
        set(PYTHON3_LIB_PATH $ENV{PYTHON3_LIB_PATH} CACHE PATH "Where the python 3 are stored")
    endif()
