...
using testing::Types;
template <typename T> class hoGTBLAS_Test : public ::testing::Test {
	protected:
	 virtual void SetUp() {
...
TYPED_TEST_CASE(hoGTBLAS_Test, Implementations);


TYPED_TEST(hoGTBLAS_Test,dotTest){
...
TYPED_TEST(hoGTBLAS_Test,axpyTest){
...
TYPED_TEST(hoGTBLAS_Test,nrm2Test){
	this->Array.fill(TypeParam(1));
...
TYPED_TEST(hoGTBLAS_Test,asumTest){
	this->Array.fill(TypeParam(1));
...
TYPED_TEST(hoGTBLAS_Test,aminTest){
...
TYPED_TEST(hoGTBLAS_Test,amaxTest){
	this->Array.fill(TypeParam(1));
