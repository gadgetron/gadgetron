...
int main(int argc, char** argv)
{
  ...
  unsigned long long num_cg_iterations = parms.get_parameter('i')->get_int_value();
  unsigned long long num_inner_iterations = parms.get_parameter('I')->get_int_value();
  unsigned long long num_outer_iterations = parms.get_parameter('O')->get_int_value();
