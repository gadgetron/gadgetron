...
private:
    ...
    {
        auto channel = Core::make_channel<Gadgetron::Server::Distributed::RemoteChannel>(address, xml_config,
...
void Gadgetron::Server::Connection::Stream::Distributed::process(Core::InputChannel input,
